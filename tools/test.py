...
def parse_args():
    ...
    parser.add_argument('--config', default="../config/nanodet_2.0x_person_v2.0.yml", type=str, help='model config file(.yml) path')
    parser.add_argument('--model', type=str, default="/mnt/wl/nanodet/tools/workspace/nanodet_2.0x_person_v2.1/model_best/model_best.ckpt", help='ckeckpoint file(.ckpt) path')
